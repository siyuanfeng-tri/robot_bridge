...
// TODO: this should go to drake maybe.

namespace drake {
namespace manipulation {

template <typename T> class SingleSegmentCartesianTrajectory {
public:
  ...
  SingleSegmentCartesianTrajectory(const Isometry3<T> &X0,
    ...
    angle_ = PiecewiseCubicTrajectory<T>(PiecewisePolynomial<T>::Cubic(
